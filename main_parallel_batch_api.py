...
IMAGE_FOLDER = '/workspace/work/zhipeng16/git/Multi_agent_image_tagging/无他图片标签测试图/2、人像细节/2.1 性别与年龄'  # 图片文件夹路径
OUTPUT_EXCEL = "/workspace/work/zhipeng16/git/Multi_agent_image_tagging/性别年龄.xlsx"
